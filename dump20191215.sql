...
INSERT INTO `connectquestionsanswers` VALUES (1,66,67),(2,68,69),(3,70,71);
...
INSERT INTO `questions` VALUES (1,1,'Where databases store data?','TEST'),(2,2,'What SQL stands for?','OPEN'),(3,2,'What CRUD stands for?','OPEN'),(4,3,'Check existing relations types','TEST'),(5,4,'Enter \"localhost\" IP address (e.g. 100.0.0.0)','OPEN'),(6,5,'What JDBC stands for?','TEST'),(7,5,'What JMX stands for?','OPEN'),(8,7,'Connect annotations to appropriate layers of application','CONNECT'),(9,8,'Should layered architecture always have 3 tiers?','TRUE_FALSE'),(10,9,'Do DropWizard always use Jetty as embedded server?','TRUE_FALSE'),(11,10,'What RPC stands for?','OPEN'),(12,11,'What is Kafka','TEST');
